/*! CharFunk 1.1.2 - Copyright (c) 2014 by Joe Larson (http://joewlarson.com), MIT License - minified 2014-05-25 */
(function (t, r) {
    "object" == typeof exports && exports ? module.exports = r : "function" == typeof define && define.amd ? define(r) : t.CharFunk = r
})(this, function () {
    "use strict";
    var t = {
        ...
        var r, n, e = {}, i = 0, u = {}, o = [];
        for (n in t)e[n] = ++i, u[n] = t[n].shift(), 0 === u[n] && (o.push([0, e[n]]), u[n] = t[n].shift());
        for (r = 1; 65535 > r; r++)for (n in t)r == u[n] && (o.push([r, e[n]]), u[n] = r + t[n].shift());
        t.CODEPOINTS = o;
        for (n in e)t[n] = e[n]
    }, c = function (t, r) {
        return a(r), t.CODEPOINTS || f(t), l(r.charCodeAt(0), t.CODEPOINTS, 0, t.CODEPOINTS.length)
    }, a = function (t) {
        if ("string" != typeof t || 1 != t.length)throw Error('A length 1 string is required for "ch" arguments.')
    }, s = function (t) {
        if ("string" != typeof t)throw Error("A string is required")
    }, h = function (t) {
        if ("function" != typeof t)throw Error("A function is required for callback")
    }, l = function (t, r, n, e) {
        var i = Math.floor((n + e) / 2);
        return t >= r[i][0] && (i >= r.length - 1 || r[i + 1][0] > t) ? r[i][1] : r[i][0] > t ? l(t, r, n, i) : l(t, r, i, e)
    }, E = function (t) {
        a(t);
        var r, e;
        r = c(n, t);
        for (e in n)if (n[e] == r)return e
    }, g = function (t, r) {
        s(t), h(r);
        var n, e, i;
        for (e = [], i = null, n = 0; t.length > n; n++)r(t.charAt(n), n, t.length) ? (null === i && (i = ""), i += t.charAt(n)) : (null !== i && e.push(i), i = null);
        return null !== i && e.push(i), e
    }, p = function (t) {
        s(t);
        var r;
        for (r = 0; t.length > r; r++)if (!N(t.charAt(r)))return !1;
        return !0
    }, d = function (r) {
        return c(t, r) == t.DIGIT
    }, O = function (r) {
        return c(t, r) == t.LETTER
    }, A = function (r) {
        return c(t, r) == t.LETTER_NUMBER
    }, N = function (r) {
        var n = c(t, r);
        return n == t.LETTER || n == t.DIGIT
    }, T = function (t) {
        return c(r, t) == r.LOWER
    }, L = function (t) {
        return c(e, t) == e.YES
    }, R = function (t) {
        return c(r, t) == r.UPPER
    }, v = function (t) {
        return a(t), "_" == t.charAt(0) || "$" == t.charAt(0) || O(t.charAt(0)) || A(t.charAt(0))
    }, S = function (t) {
        return c(i, t) == i.YES
    }, D = function (t, r) {
        if (s(t), r && o[t])return !1;
        if (!v(t.charAt(0)))return !1;
        for (var n = 1; t.length > n; n++)if (!S(t.charAt(n)))return !1;
        return !0
    }, m = function (t) {
        return c(u, t) == u.YES
    }, I = function (t, r) {
        s(t), h(r);
        var n;
        for (n = 0; t.length > n; n++)if (r(t.charAt(n), n, t.length))return n;
        return -1
    }, y = function (t, r) {
        s(t), h(r);
        var n;
        for (n = t.length - 1; n > -1; n--)if (r(t.charAt(n), n, t.length))return n;
        return -1
    }, C = function (t, r) {
        s(t), h(r);
        var n;
        for (n = 0; t.length > n; n++)if (!r(t.charAt(n), n, t.length))return !1;
        return !0
    }, w = function (t, r, n) {
        s(t), h(r), n && a(n);
        var e, i, u;
        for (u = [], e = 0; t.length > e; e++)i = r(t.charAt(e), e, t.length), "string" == typeof i ? u.push(i) : i === !0 && n ? u.push(n) : i === !1 && u.push(t.charAt(e));
        return u.join("")
    }, M = function (t, r) {
        return g(t, function (t, n, e) {
            return !r(t, n, e)
        })
    };
    return {
