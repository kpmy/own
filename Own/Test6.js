function UnitTest6(rts) {
    ...
    mod.start = function () {
        ...
        mod.$k.value((rts.math.dop(function () {
            return (rts.math.dop(function () {
                return (rts.copyOf(mod.$i.value()))
            }, "+", function () {
                return (rts.copyOf(mod.$j.value()))
            }))
        }, "+", function () {
            return (new rts.Value("INTEGER", 5))
        })));
        mod.$j.value((rts.math.mop("-", function () {
            return (rts.copyOf(mod.$i.value()))
        })));
        mod.$i.value((rts.math.dop(function () {
        ...
        mod.$p.value((rts.math.dop(function () {
            return (new rts.Value("BOOLEAN", false))
        }, "|", function () {
            return (new rts.Value("BOOLEAN", true))
        })));
        mod.$q.value((rts.math.dop(function () {
            return (new rts.Value("BOOLEAN", false))
        }, "&", function () {
            return (new rts.Value("BOOLEAN", true))
        })));
        mod.$r.value((rts.math.dop(function () {
            return (rts.math.mop("~", function () {
                return (rts.copyOf(mod.$q.value()))
            }))
        }, "&", function () {
        ...
        mod.$r.value((rts.math.dop(function () {
            ...
            return (rts.math.dop(function () {
                ...
                return (new rts.Value("INTEGER", 3))
            }))
        })));
        mod.$r.value((rts.math.dop(function () {
            return (rts.math.dop(function () {
