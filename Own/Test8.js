function UnitTest8(rts) {
    ...
    mod.$Wo2 = function () {
        ...
        $y.value(arguments[2]);
        $z.value(arguments[3]);
        $f.value((rts.math.dop(function () {
            return (rts.math.dop(function () {
                return (rts.copyOf($x.value()))
            }, "+", function () {
                return (rts.copyOf($y.value()))
            }))
        }, "+", function () {
            return (rts.copyOf($z.value()))
        })));
    ...
    mod.start = function () {
        ...
        mod.$s.value((rts.math.dop(function () {
            return (rts.math.dop(function () {
                return (rts.copyOf(mod.$s.value()))
            }, "+", function () {
                return (new rts.Value("CHAR", 44, "charCode"))
            }))
        }, "+", function () {
            return (new rts.Value("CHAR", 32, "charCode"))
        })));
        (mod.ImportLog.$Print((rts.math.dop(function () {
            return (rts.math.dop(function () {
                return (rts.copyOf(mod.$s.value()))
            }, "+", function () {
                return (new rts.Value("STRING", `V29ybGQ=`, "base64"))
            }))
        }, "+", function () {
            return (rts.math.dop(function () {
                return (new rts.Value("CHAR", 33, "charCode"))
            }, "+", function () {
                return (new rts.Value("CHAR", 13, "charCode"))
            }))
        }))));
        mod.$b.value((rts.math.dop(function () {
            return (rts.math.dop(function () {
                return (new rts.Value("STRING", `SGVsbG8=`, "base64"))
            }, "#", function () {
                return (new rts.Value("STRING", `V29sZA==`, "base64"))
            }))
        }, "&", function () {
            return (rts.math.dop(function () {
                return (new rts.Value("STRING", `V29ybGQ=`, "base64"))
        ...
        mod.$b.value((rts.math.dop(function () {
            ...
            return (rts.math.dop(function () {
                return (new rts.Value("CHAR", 52, "charCode"))
            }, "<", function () {
                return (new rts.Value("CHAR", 53, "charCode"))
            }))
        })));
        mod.$x.value((function () {
            var tmp1 = new rts.Obj(new rts.Type("INTEGER"));
            (mod.$Wo(tmp1,
                (new rts.Value("INTEGER", 5))));
            return tmp1.value();
        }()));
        mod.$x.value((function () {
            var tmp2 = new rts.Obj(new rts.Type("INTEGER"));
        ...
        mod.$x.value((function () {
            var tmp3 = new rts.Obj(new rts.Type("ANY"));
            mod.$inf.call(tmp3,
                (new rts.Value("INTEGER", 5)));
            return tmp3.deref().value();
        }()));
        mod.$ch.value((function () {
            var tmp4 = new rts.Obj(new rts.Type("INTEGER"));
